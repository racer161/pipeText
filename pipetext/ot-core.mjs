...
//performs the operation on the document
function xi(tree, i) {
	var base = 0;
	while (tree != null) {
		var left = tree.left;
...
//undoes the given operation on the document
...
//ahh recursively descends tree until it finds the character then
//it deletes the character by unioning the two nodes that are now disconnected 
...
// \Xi_{i}(S)
//Increments all indices past certain index
